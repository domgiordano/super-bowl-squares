-- Fix the payment trigger function - was trying to select wrong column
...
DECLARE
  ...
  v_square_count INT;
BEGIN
  -- Get group_id from the game that this square belongs to
  SELECT g.group_id, g.buy_in_amount INTO v_group_id, v_buy_in
  FROM public.games g
